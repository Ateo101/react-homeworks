...
export const pureOnBlur = (name: string,
                           setError: React.Dispatch<React.SetStateAction<string>>) => { // если имя пустое - показать ошибку
    name.trim() ? setError('')
         : setError(`Ошибка! Введите имя!`)
}

export const pureOnEnter = (e: KeyboardEvent<HTMLInputElement>,
                            addUser: GreetingContainerPropsType['addUserCallback']) => { // если нажата кнопка Enter - добавить
    if (e.key === 'Enter') {addUser(addUser.name)}
}
